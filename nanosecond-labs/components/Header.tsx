    ...
    <div className="w-full">
      ...
      <div className="px-8 md:px-12 py-6 flex justify-between items-end border-b-4 border-double border-ns-ink">
        ...
        <div className="hidden md:flex flex-col items-end">
            <div className="font-sans font-bold text-xs uppercase tracking-widest border border-ns-ink px-2 py-1 mb-1">
                Est. 2024
            </div>
      ...
      <div className="group w-full h-[300px] md:h-[450px] bg-neutral-900 relative overflow-hidden grayscale contrast-125 cursor-crosshair border-b border-ns-ink">
         ...
         <div className="absolute bottom-4 right-4 text-white/50 font-sans text-[10px] tracking-widest uppercase z-20 group-hover:text-white transition-colors">
            {figCaption}
         </div>
      </div>

      {/* Caption Strip */}
      <div className="border-b-2 border-ns-ink py-2 px-8 md:px-12 flex items-center">
        <p className="font-sans text-[9px] md:text-[10px] font-bold uppercase tracking-widest leading-tight text-ns-ink w-full text-justify">
          SCIENTIST OF THE FUTURE RECORDS EXPERIMENTS WITH A TINY CAMERA FITTED WITH UNIVERSAL-FOCUS LENS. THE SMALL SQUARE IN THE EYEGLASS AT THE LEFT RECORDS THE DATA STREAM OF THE LLM.
        </p>
      </div>
    </div>
  );
